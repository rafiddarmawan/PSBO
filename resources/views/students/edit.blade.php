            ...
            <div class="mt-3">
                ...
                <form method="post" action="/students/{{ $student->id }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" placeholder="Masukkan NIS" name="nis" value="{{ $student->nis }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" placeholder="Masukkan Asrama" name="asrama" value="{{ $student->asrama }}">
